...
function BlockBComplaints({ complaintsBlockB }) {
  return (
    <div className="flex flex-col w-[200px] p-4 space-y-4 bg-gradient-to-r from-orange-500 to-orange-600 rounded-xl text-white shadow-lg hover:shadow-2xl transition-shadow duration-300">
      {/* Header */}
      <div className="flex flex-row justify-between items-center">
      ...
      <div className="text-xs text-center">
        Total number of Complaints in Block B
      </div>
    </div>
  );
}
