...
public class FeedbackController {
    ...
    public FeedbackResponse submitFeedback(@RequestHeader("Authorization") String jwt,@RequestBody FeedbackDto feedbackDto, @PathVariable Long eventId) throws Module3Exception {
        return feedbackService.submitFeedback(feedbackDto,eventId);
    }
